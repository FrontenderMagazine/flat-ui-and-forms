...
его критерии могут изменяться в зависимости от конкретных обстоятельств.
...
том, что в погоне за простотой плоский интерфейс зашёл наверное *слишком* далеко. 
...
Возьмём к примеру действия «подтвердить» и «отмена». Очевидно, что они дают 
очень разный результат и нам нужно чтобы пользователь быстро и без проблем 
...
в его качестве использовался фоновый цвет полосы шапки). Результат? Толпы 
